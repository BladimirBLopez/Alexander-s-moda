...
export default function BotonCompartir() {
  ...
  return (
    <button
      ...
      className="w-10 h-10 rounded-full bg-[var(--color-hueso)]/15 border border-[var(--color-hueso)]/40 flex items-center justify-center text-[var(--color-hueso)] hover:bg-[var(--color-hueso)]/25 transition"
    >
