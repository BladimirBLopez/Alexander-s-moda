    ...
    <>
      <div className="absolute inset-0 w-full h-full">
        ...
        <button
          ...
          className="absolute bottom-2 right-2 w-6 h-6 rounded-full bg-white/85 text-[var(--color-bordo)] flex items-center justify-center active:scale-90 transition-transform"
        >
