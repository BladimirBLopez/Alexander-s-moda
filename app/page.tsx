            ...
            <Link
              ...
              className={
                (enlace.destacado
                  ...
                  : "bg-[var(--color-bordo-oscuro)]/40 border border-[var(--color-hueso)]/40 text-[var(--color-hueso)] hover:border-[var(--color-hueso)] hover:bg-[var(--color-bordo-oscuro)]/60") +
                " boton-tactil w-full py-3.5 px-4 rounded-full font-medium tracking-wide flex items-center gap-3 text-sm transition-colors"
              }
            >
              <span
                className={
                  (enlace.destacado
                    ? "bg-[var(--color-bordo-oscuro)] text-[var(--color-hueso)]"
                    : "bg-[var(--color-hueso)] text-[var(--color-bordo-oscuro)]") +
                  " w-8 h-8 rounded-full flex items-center justify-center shrink-0"
                }
              >
                {enlace.icono}
              </span>
              <span className="flex-1 text-left">{enlace.label}</span>
            </Link>
          ))}
        </div>
      </div>
