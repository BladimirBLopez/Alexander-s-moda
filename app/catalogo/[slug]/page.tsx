...
function ColumnaGenero2({
  ...
  return (
    <div className={bordeDerecho ? "border-r border-[var(--color-hueso)]/50 -mt-4 pt-4 -mb-6 pb-6" : ""}>
    ...
    <div className={`h-full flex flex-col items-center justify-center gap-10 ${invertido ? "border-r border-[var(--color-hueso)]/50 -my-4 py-4 pr-3" : ""}`}>
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-2 mt-2">
          ...
          <VerColores label={titulo.includes("Dama") ? "Color falda" : "Color pantalón"} mostrarCaracteristicas={false} filtroTelas={["fill-a-fill-profesional"]} />
        </div>
      </div>
