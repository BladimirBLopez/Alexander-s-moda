  ...
  return (
    <main className="min-h-screen bg-[var(--color-papel)]">
              ...
              <article key={producto.id} className="[&:not(:first-child)]:pespunte-hueso [&:not(:first-child)]:pt-8">
                ...
                <div className="mt-6">
                  <div className="relative w-full h-6 mb-6">
                    <Image
                      src="https://res.cloudinary.com/dkq95jus0/image/upload/v1786838463/flourish-divider.png"
                      alt=""
                      fill
      ...
      <Link
        ...
        className="fixed bottom-5 right-5 z-20 w-14 h-14 rounded-full bg-[#25D366] shadow-lg flex items-center justify-center hover:scale-105 transition-transform"
      >
